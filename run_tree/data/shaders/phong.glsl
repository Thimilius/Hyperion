...
void main() {
	...
	vec3 to_light_direction = normalize(u_light.position - fs_in.position);
	...
	vec3 to_camera_direction = normalize(u_camera.position - fs_in.position);
	vec3 reflection_direction = reflect(-to_light_direction, fs_in.normal);
