...
namespace Hyperion::UI {
  ...
  private:
    ...
    static void SendEvent(UIElement *element, UIEventType type, KeyCode key_code = KeyCode::None, KeyModifier key_modifier = KeyModifier::None, const String &key_typed = "");
  };
