...
namespace Hyperion::Rendering {
    ...
    public:
        ...
        static void DrawText(Font *font, const String &text, Vec2 position, float32 scale, Color color);
    ...
    private:
        ...
        inline static Mesh *s_font_mesh;
        inline static MeshData s_font_mesh_data;
        inline static Material *s_font_material;
