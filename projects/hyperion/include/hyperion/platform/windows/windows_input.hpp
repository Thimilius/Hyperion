...
namespace Hyperion {
    ...
    public:
        ...
        bool GetKey(KeyCode key_code) const override { return m_keys[static_cast<int32>(key_code)]; }
        bool GetKeyUp(KeyCode key_code) const override { return m_keys_up[static_cast<int32>(key_code)]; }

        Vec2 GetMousePosition() const override { return m_mouse_position; }
        float32 GetMouseScroll() const override { return m_mouse_scroll; }

        bool GetMouseButtonDown(MouseButtonCode mouse_button_code) const override { return m_mouse_buttons_down[static_cast<int32>(mouse_button_code)]; }
        bool GetMouseButton(MouseButtonCode mouse_button_code) const override { return m_mouse_buttons[static_cast<int32>(mouse_button_code)]; }
        bool GetMouseButtonUp(MouseButtonCode mouse_button_code) const override { return m_mouse_buttons_up[static_cast<int32>(mouse_button_code)]; }
        ...
        bool GetGamepadButtonDown(Gamepad gamepad, GamepadButtonCode gamepad_button_code) const override { return m_gamepads[static_cast<int32>(gamepad)].buttons_down[static_cast<int32>(gamepad_button_code)]; }
        bool GetGamepadButton(Gamepad gamepad, GamepadButtonCode gamepad_button_code) const override { return m_gamepads[static_cast<int32>(gamepad)].buttons[static_cast<int32>(gamepad_button_code)]; }
        bool GetGamepadButtonUp(Gamepad gamepad, GamepadButtonCode gamepad_button_code) const override { return m_gamepads[static_cast<int32>(gamepad)].buttons_up[static_cast<int32>(gamepad_button_code)]; }
    private:
