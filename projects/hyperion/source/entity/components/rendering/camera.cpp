...
namespace Hyperion {
    ...
    Ray Camera::ScreenPointToRay(Vec2 screen_point) const {
        ...
        switch (m_data.projection_mode) {
            ...
            case CameraProjectionMode::Orthographic: {
                ...
                float32 l = -m_data.orthographic_size * aspect_ratio;
                float32 r = m_data.orthographic_size * aspect_ratio;
                float32 t = m_data.orthographic_size;
                float32 b = -m_data.orthographic_size;
    ...
    void Camera::RecalculateMatricies() {
        ...
        switch (m_data.projection_mode) {
            ...
            case CameraProjectionMode::Orthographic: {
                float32 size = m_data.orthographic_size;
