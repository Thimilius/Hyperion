...
namespace Hyperion::Rendering {
    ...
    u32 OpenGLShaderCompiler::Compile(const String &source) {
        OpenGLShaderPreProcessResult pre_process_result = OpenGLShaderCompiler::PreProcess(source);
    ...
    void OpenGLShaderCompiler::Init() {
        ...
        s_fallback_shader = Compile(FileUtilities::ReadTextFile(shader_path + "/internal/standard_fallback.glsl"));
    }
