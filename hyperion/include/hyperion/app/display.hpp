...
namespace Hyperion {
    ...
    private:
        TString m_name;
        bool m_is_primary;
        TVector<SDisplayModeInfo> m_mode_infos;
    public:
        inline const TString &GetName() const { return m_name; }
        inline bool IsPrimary() const { return m_is_primary; }
        inline const TVector<SDisplayModeInfo> &GetModeInfos() const { return m_mode_infos; }
    ...
    class CDisplay {
    private:
        inline static TVector<CDisplayInfo> s_display_infos;
    public:
        inline static const TVector<CDisplayInfo> &GetDisplayInfos() { return s_display_infos; }
